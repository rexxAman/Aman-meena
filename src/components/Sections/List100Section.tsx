...
const GOALS_LIST: GoalItem[] = [
  { id: 1, text: 'Get married', done: false },
  ...
  { id: 6, text: 'Go on a road trip', done: true },
  ...
  { id: 11, text: 'Publish research on multimodal AI deception detection', done: true },
  { id: 12, text: 'Build an enterprise RAG system serving live users', done: true },
  { id: 13, text: 'Earn top-tier P3 rating at Accenture Software Internship', done: true },
  { id: 14, text: 'Ship 5+ full-stack open source products and developer tools', done: true },
  { id: 15, text: 'Build and deploy a custom Model Context Protocol (MCP) server', done: true },
  { id: 16, text: 'Master strict TypeScript and modern Next.js ecosystem', done: true },
  ...
  { id: 35, text: 'Host a technical workshop on LLM agent architecture', done: true },
];
